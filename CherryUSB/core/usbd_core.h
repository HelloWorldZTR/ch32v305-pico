...
enum usbd_event_type {
    ...
    USBD_EVENT_UNKNOWN,
    /** Active configuration was cleared */
    USBD_EVENT_UNCONFIGURED
};
...
/**
 * @brief Detach the controller and clear the active USB configuration state.
 *
 * @return 0 on success, otherwise a controller-specific negative value.
 */
